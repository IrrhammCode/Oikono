...
async function recordMetric() {
    ...
    try {
        ...
        try {
            ...
            console.warn('getMetricDef failed (may be new metric):', e.message);
        }
        ...
        if (!isDefined) {
            ...
            try {
                ...
                showNotification('TX sent: ' + defTx.hash, 'info');
                await defTx.wait();
                showNotification('Metric defined!', 'success');
            } catch (e) {
                console.error('defineMetric failed:', e);
                showNotification('Define failed: ' + parseError(e), 'error');
                return;
            }
        }
...
const EXAMPLE_DATA = [
    ...
    { name: "WagerVerse Arena", type: "pvp", desc: "Competitive PvP wager arena with delegated gameplay, profile NFTs, and real-time matchmaking on Somnia", primary: "0xd5f3E959b213e1B6811852bB7F4Ea8a5C868e21c", contracts: [{ address: "0xEFA95569C06B8D77fC80092cf5BAa7f766728b83", role: "token" }, { address: "0x2049Bc9475B88B55D6d43aE28263D68719251113", role: "nft" }], winRate: 45, retention: 25, inflation: "medium", economy: "balanced", maxChange: 18, epoch: 6000, spawn: true, econPerm: false, narrative: false, difficulty: true, autonomy: "semi-auto", tokenName: "Play Token", tokenSym: "PLAY", totalSupply: "500000000", circSupply: "100000000", utility: "utility", sinks: ["entry","market","staking"], sources: ["battle","staking"] },
    { name: "Worms Arena", type: "strategy", desc: "Turn-based strategy battler with on-chain worm armies, terrain destruction, and seasonal leaderboards", primary: "0x01BcdC8eD5Ac27Fe0dFF13c71EEE7e4B2c23D182", contracts: [{ address: "0xEFA95569C06B8D77fC80092cf5BAa7f766728b83", role: "token" }, { address: "0x7A1c5324E53bE135fe71415362CB9f61D98dC51C", role: "nft" }], winRate: 50, retention: 35, inflation: "low", economy: "deflationary", maxChange: 12, epoch: 5500, spawn: true, econPerm: true, narrative: false, difficulty: true, autonomy: "manual", tokenName: "Worm Token", tokenSym: "WORM", totalSupply: "200000000", circSupply: "50000000", utility: "utility", sinks: ["entry","craft","market"], sources: ["battle","quest"] },
    { name: "Infinite Craft", type: "sandbox", desc: "On-chain crafting game with composable NFT items, recipe discovery, and player-driven marketplace", primary: "0xeb6c713Fd7292ced58fa13eEf3DBd5c9Dfdb40e2", contracts: [{ address: "0xEFA95569C06B8D77fC80092cf5BAa7f766728b83", role: "token" }, { address: "0x311Fd4EfE770A473F4eC36C3688a506c43a521b8", role: "nft" }, { address: "0xA530dbDB02f46F4A1B7c18cEE8eA57148fC470Ae", role: "marketplace" }], winRate: 65, retention: 50, inflation: "low", economy: "deflationary", maxChange: 8, epoch: 4500, spawn: false, econPerm: true, narrative: true, difficulty: false, autonomy: "full-auto", tokenName: "Craft Token", tokenSym: "CRAFT", totalSupply: "100000000", circSupply: "30000000", utility: "utility", sinks: ["craft","market","staking"], sources: ["quest","staking"] },
    { name: "Void Hunters", type: "rpg", desc: "Dark sci-fi RPG with void creature hunting, NFT loot drops, and cooperative dungeon raids", primary: "0xccbFe6Cb15E50CB540BB3dcbeBd0333564C1Daf0", contracts: [{ address: "0x2aEF61f7e8ce921139d0a724E0C10f016F572d32", role: "token" }, { address: "0x7A1c5324E53bE135fe71415362CB9f61D98dC51C", role: "nft" }, { address: "0xA03916C493cc00869FBd1D56cb89ba0d14A12116", role: "token" }], winRate: 40, retention: 28, inflation: "high", economy: "inflationary", maxChange: 25, epoch: 7000, spawn: true, econPerm: true, narrative: true, difficulty: true, autonomy: "semi-auto", tokenName: "Phoenix Token", tokenSym: "PHX", totalSupply: "300000000", circSupply: "80000000", utility: "mixed", sinks: ["entry","craft","market","staking"], sources: ["battle","quest","staking"] },
    { name: "Kingsomni", type: "card", desc: "Strategic card game set in the Somnia kingdom, with land ownership, alliance wars, and seasonal rewards", primary: "0x9839E260f5C10e1fd975214bDdd498a8D39FcB12", contracts: [{ address: "0x5A9A4d5022CceEDCCE9B3603BF91846bFF586d2e", role: "token" }, { address: "0xB9D473f711Ba34Aa5a390b15754eDbc670bd3014", role: "nft" }], winRate: 48, retention: 32, inflation: "medium", economy: "balanced", maxChange: 15, epoch: 6500, spawn: false, econPerm: true, narrative: true, difficulty: false, autonomy: "semi-auto", tokenName: "LOL Token", tokenSym: "LOL", totalSupply: "150000000", circSupply: "45000000", utility: "governance", sinks: ["entry","craft","market"], sources: ["quest","staking"] },
    { name: "Gamers Lab", type: "puzzle", desc: "Proof-of-play puzzle platform with on-chain score anchoring, achievement NFTs, and daily challenges", primary: "0x197B377E88f7EbB0Dd130a1c2EAC40193930F4B4", contracts: [{ address: "0xB302FB928A069eF0787bC6742EE76077aa4e95A9", role: "token" }, { address: "0x59Ac7f95EC775618c84b13B7f57354963B7b0f24", role: "nft" }], winRate: 60, retention: 45, inflation: "low", economy: "deflationary", maxChange: 5, epoch: 4000, spawn: false, econPerm: false, narrative: true, difficulty: false, autonomy: "manual", tokenName: "Prophecy Token", tokenSym: "PROPH", totalSupply: "80000000", circSupply: "20000000", utility: "utility", sinks: ["entry","craft"], sources: ["quest"] },
    { name: "Somn Tournament", type: "racing", desc: "High-speed on-chain racing tournaments with NFT vehicles, pit stop strategy, and seasonal championships", primary: "0x04cdcC114616F37bA1D1CcC4f5248DbB2E782912", contracts: [{ address: "0xEFA95569C06B8D77fC80092cf5BAa7f766728b83", role: "token" }, { address: "0x1A706669ef9fB07605C51A7daF68B7db107D141a", role: "nft" }, { address: "0xA530dbDB02f46F4A1B7c18cEE8eA57148fC470Ae", role: "staking" }], winRate: 52, retention: 38, inflation: "medium", economy: "balanced", maxChange: 20, epoch: 8000, spawn: true, econPerm: true, narrative: false, difficulty: true, autonomy: "full-auto", tokenName: "Race Token", tokenSym: "RACE", totalSupply: "400000000", circSupply: "120000000", utility: "mixed", sinks: ["entry","market","staking"], sources: ["battle","staking"] },
    { name: "NFT Bridge World", type: "simulation", desc: "Cross-chain simulation with NFT bridging, resource management, and AI-driven economy balancing", primary: "0x098f6C6B1c80460aD896F63900D84D4e64BFA926", contracts: [{ address: "0x94F3E5c84755d0B2Fd0e7A560F2724C2A9529E7A", role: "token" }, { address: "0xB9D473f711Ba34Aa5a390b15754eDbc670bd3014", role: "nft" }, { address: "0xA03916C493cc00869FBd1D56cb89ba0d14A12116", role: "marketplace" }, { address: "0xA530dbDB02f46F4A1B7c18cEE8eA57148fC470Ae", role: "staking" }], winRate: 55, retention: 42, inflation: "medium", economy: "balanced", maxChange: 15, epoch: 9000, spawn: true, econPerm: true, narrative: true, difficulty: false, autonomy: "full-auto", tokenName: "Bridge Token", tokenSym: "BRDG", totalSupply: "600000000", circSupply: "180000000", utility: "governance", sinks: ["craft","market","staking"], sources: ["quest","staking","airdrop"] },
    { name: "DeFi Arena", type: "defi", desc: "DeFi gaming arena with yield farming mechanics, token wagering, and liquidity mining rewards", primary: "0x9532A3Ac3a3ba2AAcbc6bbd21ede6dDED49d86F8", contracts: [{ address: "0xA03916C493cc00869FBd1D56cb89ba0d14A12116", role: "token" }, { address: "0x8B0E52280c2E5047B8fd7AffD20333f36463b037", role: "nft" }, { address: "0xA530dbDB02f46F4A1B7c18cEE8eA57148fC470Ae", role: "staking" }], winRate: 50, retention: 35, inflation: "medium", economy: "balanced", maxChange: 20, epoch: 6000, spawn: false, econPerm: true, narrative: false, difficulty: false, autonomy: "full-auto", tokenName: "Arena Token", tokenSym: "ARENA", totalSupply: "500000000", circSupply: "120000000", utility: "mixed", sinks: ["entry","market","staking"], sources: ["quest","staking"] }
];
